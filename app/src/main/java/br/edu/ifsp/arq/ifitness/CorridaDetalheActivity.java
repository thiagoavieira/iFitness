...
public class CorridaDetalheActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corrida_detalhe);
        ...
        txtTitulo.setText("Registrar Atividade: Corrida");
        ...
        btnConfirmar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                usuarioViewModel.isLogged().observe(CorridaDetalheActivity.this, new Observer<Usuario>() {
                    @Override
                    public void onChanged(Usuario usuario) {
                        if(usuario != null){
                            if(validate())
                            {
                                ...
                                Toast.makeText(CorridaDetalheActivity.this, R.string.msg_atividade_sucesso, Toast.LENGTH_SHORT).show();
                            }

                        } else {
                            Intent intent = new Intent(CorridaDetalheActivity.this,
        ...
        btnAtualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                usuarioViewModel.isLogged().observe(CorridaDetalheActivity.this, new Observer<Usuario>() {
                    ...
                    public void onChanged(Usuario usuario) {
                        if (usuario != null) {
                            CorridaDetalheActivity.this.usuario = usuario;
                            ...
                            if (validate()) {
                                ...
                                Toast.makeText(CorridaDetalheActivity.this, "Dados da corrida atualizados!", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(CorridaDetalheActivity.this, MainActivity.class);
                                startActivity(intent);
                            }
                        }
                    }
                ...
                usuarioViewModel.isLogged().observe(CorridaDetalheActivity.this, new Observer<Usuario>() {
                    ...
                    public void onChanged(Usuario usuario) {
                        if (usuario != null) {
                            ...
                            Toast.makeText(CorridaDetalheActivity.this, "Dados da corrida removidos!", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(CorridaDetalheActivity.this, MainActivity.class);
                            startActivity(intent);
                        }
                    }
